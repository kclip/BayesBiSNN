...
x_train, y_train, x_test, y_test, x_train_bin, x_test_bin = gen_1d_signal_realtarget(T=T, step=step, n_neuron_per_dim=n_neurons_per_dim)
...
for epoch in range(args.n_epochs):
    ...
    if (epoch + 1) % args.test_period == 0:
        ...
        predictions_mode_train, idxs_train_mode = mode_testing(binary_model, optimizer, burnin, n_examples_train, args.batch_size, x_test_bin, T, args.device)
        ...
        predictions_mean_test, idxs_test_mean = mean_testing(binary_model, optimizer, burnin, n_samples, 2, n_examples_test, args.batch_size, x_test_bin, T, args.device)
        ...
        predictions_mean_train, idxs_train_mean = mean_testing(binary_model, optimizer, burnin, n_samples, 2, n_examples_train, args.batch_size, x_test_bin, T, args.device)
